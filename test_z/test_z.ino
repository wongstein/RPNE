...
//const int Z = 13200;        //40 steps per mm, very acceptable for 7 ml
const int Z = 13900;        //40 steps per mm, very acceptable for 5 ml, not much room for error
...
void setup() {
  ...
  //Test here
  //moveTo(xTub,yTub); //first test tube
  //moveZ(Z,zspd); 
  //dunkProbe(0,0,0); //record nothing
  moveZ(-200,zspd); 
}
